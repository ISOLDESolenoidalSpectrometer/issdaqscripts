...
REACTIONFILE="reaction_94Rb_20221026.dat"
...
iss_sort -s $CONFIGDIR/$SETTINGSFILE -c $CONFIGDIR/$CALIBFILE -r $CONFIGDIR/$REACTIONFILE -i $DATAFILES -o 94Rb_sum_hists_${CURTIME}.root
